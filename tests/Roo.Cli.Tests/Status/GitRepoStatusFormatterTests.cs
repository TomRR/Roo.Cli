...
{
    private readonly RepositoryDto _testRepositoryDto =  RepositoryDtoFactory.Create(url: "/tmp/testrepo");
    ...
    public void Format_ReturnsCleanMessage_WhenRepoIsClean()
    {
        ...
        var result = GitRepoStatusFormatter.Format(_testRepositoryDto, status);
    ...
    public void Format_ReturnsEmpty_WhenCleanAndOnlyIfChangesIsTrue()
    {
        ...
        var result = GitRepoStatusFormatter.Format(_testRepositoryDto, status, onlyIfChanges: true);
